    ...
    >
      ...
      <div class="flex items-center gap-1">
        ...
        <div class="flex items-center gap-2 pl-1">
          <div
            class="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900/40 flex items-center justify-center text-blue-600 dark:text-blue-400 font-semibold text-sm select-none"
          >
            Y
          </div>
          <span
            class="hidden sm:block text-sm font-medium text-gray-700 dark:text-gray-200"
            >Yulia</span
          >
        </div>
      </div>
